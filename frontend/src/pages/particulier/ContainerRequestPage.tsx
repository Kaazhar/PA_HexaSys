import { LayoutDashboard, Tag, PlusCircle, Package, Star, Calendar, BookOpen, MapPin, CheckCircle } from 'lucide-react';
...
export default function ContainerRequestPage() {
  ...
  return (
    <DashboardLayout sidebarItems={sidebarItems} title="Demande de dépôt en conteneur">
