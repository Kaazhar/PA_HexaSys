...
import { LayoutDashboard, Tag, PlusCircle, Package, Star, Calendar, BookOpen, CheckCircle } from 'lucide-react';
...
export default function CreateListingPage() {
  ...
  const createMutation = useMutation({
    ...
    onError: (err: unknown) => {
      ...
      if (error.response?.data?.error === 'limite_abonnement') {
        toast.error(error.response.data.message || 'Limite d\'annonces atteinte. Passez à un plan supérieur.', { duration: 6000 });
      } else {
