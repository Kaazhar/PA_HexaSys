...
export default function ScorePage() {
  ...
  return (
    <DashboardLayout sidebarItems={sidebarItems} title={t('score.title')}>
      {isLoading ? (
        ...
        <div className="space-y-6 max-w-3xl">
          ...
          <div className="bg-gradient-to-br from-primary-500 to-primary-700 rounded-2xl p-8 text-white text-center">
            ...
            <p className="text-white/70 uppercase tracking-widest text-sm mb-1">{t('score.level')}</p>
            ...
            <p className="text-white/70">{t('score.points')}</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="card text-center">
              ...
              <p className="text-sm text-gray-500 mt-1">{t('score.wasteAvoided')}</p>
            </div>
            <div className="card text-center">
              ...
              <p className="text-sm text-gray-500 mt-1">{t('score.co2Saved')}</p>
            </div>
            <div className="card text-center">
              ...
              <p className="text-sm text-gray-500 mt-1">{t('score.waterSaved')}</p>
            </div>
          </div>
          ...
          {chartData.length > 1 && (
            <div className="card">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="font-semibold text-gray-900">{t('score.history')}</h2>
              </div>
