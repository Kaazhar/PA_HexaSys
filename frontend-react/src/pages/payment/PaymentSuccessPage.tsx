        ...
        {loading ? (
          ...
          <>
            ...
            <div className="space-y-3">
              ...
              <Link
                to={getDashboardPath()}
                className={`flex items-center justify-center w-full py-3 px-4 rounded-xl font-medium transition-colors ${result?.invoice_id ? 'border-2 border-gray-200 text-gray-700 hover:bg-gray-50' : 'bg-[#2D5016] text-white hover:bg-[#3a6a1e]'}`}
              >
