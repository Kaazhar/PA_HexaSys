...
(NOW(), NOW(), 'Conteneur République', 'Place de la République', '75011', 30, 12, 'operational', 48.8674, 2.3634),
(NOW(), NOW(), 'Conteneur Bastille', 'Place de la Bastille', '75012', 25, 20, 'operational', 48.8533, 2.3692),
(NOW(), NOW(), 'Conteneur Nation', 'Place de la Nation', '75011', 20, 5, 'operational', 48.8484, 2.3961),
(NOW(), NOW(), 'Conteneur Oberkampf', 'Rue Oberkampf', '75011', 15, 15, 'full', 48.8635, 2.3740),
(NOW(), NOW(), 'Conteneur Marais', 'Rue de Bretagne', '75003', 25, 8, 'operational', 48.8629, 2.3625);
